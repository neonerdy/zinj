...
import com.xeris.zinj.model.Budget;
...
public class BudgetByYearAdapter extends ArrayAdapter<Budget>
{
    ...
    public BudgetByYearAdapter(Context context, int layoutResourceId, ArrayList<Budget> data)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(v == null)
        {
            ...
            holder.lblMonth=(TextView)v.findViewById(R.id.lblChartBudgetMonth);
        ...
        if (budget!=null)
        {
            float used=chartRepository.getUsedBudgetByYear(budget.getCategoryId(), Integer.parseInt(budget.getMonth()),year);
            ...
            holder.lblMonth.setText(Store.getMonthString(Integer.parseInt(budget.getMonth())));
