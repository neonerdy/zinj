...
public class ChartByTodayAdapter extends ArrayAdapter<Chart>
{
    ...
    public ChartByTodayAdapter(Context context, int layoutResourceId, ArrayList<Chart> data, CategoryType type)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (chart!=null)
        {
            float total=chartRepository.getTotalAmountByToday(type);
